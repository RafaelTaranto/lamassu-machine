...
var Id003Rs232 = function (config) {
  ...
  this.config = config
  this.serial = null
  this._denominations = null
  this.commands = []
}

util.inherits(Id003Rs232, EventEmitter)
Id003Rs232.factory = function factory (config) {
...
Id003Rs232.prototype._parseData = function _parseData (command, rawData) {
  switch (command) {
    ...
    case 'denominations': return this._setDenominations(rawData)
    case 'getEnabled':
...
Id003Rs232.prototype._escrow = function _escrow (rawData) {
  ...
  var denomination = this._denominations[fiatCode]
...
Id003Rs232.prototype.denominations = function denominations () {
  return this._denominations
}

Id003Rs232.prototype._setDenominations = function _setDenominations (rawData) {
  ...
  for (var offset = 0; offset < rawLength; offset += 4) {
    ...
    this._denominations[escrowCode] = denomination
  }
}
