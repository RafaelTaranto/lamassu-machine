...
BillDispenser.prototype.init = function init (data) {
  return new Promise((resolve) => {
    ...
    this._registerLicenseKey(this.license)
    this._openEx(this.license, this.device)
...
BillDispenser.prototype._registerLicenseKey = function _registerLicenseKey (license) {
  this._throwMakeError(cdu.registerLicenseKey(license))
}

BillDispenser.prototype._openEx = function _openEx (license, serialPortName) {
  if (!serialPortName) throw new Error('No serial port name provided!')
  this._throwMakeError(cdu.openEx(license, serialPortName))
}
