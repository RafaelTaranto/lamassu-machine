...
const Trader = function (clientCert, connectionInfo, dataPath, relayedModel) {
  ...
  const restrictionLevel = this._loadRestrictionLevel()
...
Trader.prototype._loadRestrictionLevel = function _loadRestrictionLevel () {
  return restrictionInfoLoader.load(this.dataPath)?.level
}
